...
public class RouteBetweenNodesMain {
    ...
    public static void main(String[] args) {
        ...
        graph.identifyRouteBetweenTwoNodes(nodeList.get(0), nodeList.get(7));
        graph.identifyRouteBetweenTwoNodes(nodeList.get(0), nodeList.get(4));
